...
// 2019-02-14 17:46:35.76268 -0800 PST m=+0.005131800
package writers
...
var (
	...
	routesBodyTemplate *text.Template
...
func init() {
	...
	routesBodyTemplate, err = text.New("templates/routes_body.go.tmpl").Parse(routesBodyTempl)
	if err != nil {
		log.Fatal(err)
	}
...
func Routes(cxt page.Context, m page.Mux, renderer *treetop.Renderer) {
	{{ block "rotuesbody" . }}{{ end }}
}
`

// templates/routes_body.go.tmpl
var routesBodyTempl = `{{ block "rotuesbody" . -}}
