...
// 2020-03-04 16:53:03.582285 -0800 PST m=+0.002711544
package writers
...
type Context interface {
	Bind(ResourceHandler) treetop.ViewHandlerFunc
}
...
func (c *cxt) Bind(f ResourceHandler) treetop.ViewHandlerFunc {
...
[[ end ]]
    ...
    <script async src="https://rawgit.com/rur/treetop-client/tt-v030/treetop.js"></script>
</body>
</html>`
...
func (s StandardMux) Handle(pattern string, handler http.Handler) {
	s.Mux.HandleFunc(pattern, func(w http.ResponseWriter, req *http.Request) {
		handler.ServeHTTP(w, req)
	})
}
...
func Routes(cxt page.Context, m page.Mux, exec treetop.ViewExecutor) {
	{{ block "routes" . }}
...
func (s *server) LoadResources(responseID uint32, cxt context.Context, req *http.Request) (*Resources, error) {
	...
	s.RUnlock() // don't need this lock any more
